class Joint < ActiveRecord::Base
  ...
  def self.search(search)
    if (search)
      ...
      where 'LOWER(titreoriginal) LIKE :search OR LOWER(titreoriginalb) LIKE :search OR LOWER(genre) LIKE :search OR LOWER(date) LIKE :search OR LOWER(price) LIKE :search OR LOWER(show) LIKE :search OR LOWER(schedule) LIKE :search OR LOWER(onstage) LIKE :search OR LOWER(episode) LIKE :search OR LOWER(audience) LIKE :search OR LOWER(source) LIKE :search OR LOWER(comment) LIKE :search OR LOWER(day) LIKE :search OR LOWER(daybis) LIKE :search OR LOWER(dayextra) LIKE :search OR ville_id IN (:ville_ids) OR salle_id IN (:salle_ids)', 
